...
module floating_point_multiplier_sequential ( a, b, result, overflow, clk, rst
  ...
  NBUFFX2 U7 ( .INP(n8), .Z(n11) );
  NBUFFX2 U8 ( .INP(n8), .Z(n12) );
  NBUFFX2 U9 ( .INP(n8), .Z(n13) );
  NBUFFX2 U10 ( .INP(n9), .Z(n14) );
  NBUFFX2 U11 ( .INP(n9), .Z(n15) );
  NBUFFX2 U12 ( .INP(n9), .Z(n16) );
  NBUFFX2 U13 ( .INP(n10), .Z(n17) );
  NBUFFX2 U14 ( .INP(n10), .Z(n18) );
  NBUFFX2 U15 ( .INP(n10), .Z(n19) );
  NBUFFX2 U16 ( .INP(n31), .Z(n8) );
  NBUFFX2 U17 ( .INP(n31), .Z(n9) );
  NBUFFX2 U18 ( .INP(n31), .Z(n10) );
  NBUFFX2 U19 ( .INP(n28), .Z(n27) );
  NBUFFX2 U20 ( .INP(n28), .Z(n26) );
  NBUFFX2 U21 ( .INP(n29), .Z(n25) );
  NBUFFX2 U22 ( .INP(n29), .Z(n24) );
  NBUFFX2 U23 ( .INP(n29), .Z(n23) );
  NBUFFX2 U24 ( .INP(n30), .Z(n22) );
  NBUFFX2 U25 ( .INP(n30), .Z(n21) );
  NBUFFX2 U26 ( .INP(n30), .Z(n20) );
  AND2X1 U27 ( .IN1(n7), .IN2(n3), .Q(N3) );
  INVX0 U28 ( .INP(rst), .ZN(n31) );
  NBUFFX2 U29 ( .INP(slow_clk), .Z(n28) );
  NBUFFX2 U30 ( .INP(slow_clk), .Z(n29) );
  NBUFFX2 U31 ( .INP(slow_clk), .Z(n30) );
endmodule

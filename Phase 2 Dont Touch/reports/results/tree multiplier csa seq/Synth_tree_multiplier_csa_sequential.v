...
// Date      : Sat Dec 23 20:33:33 2023
/////////////////////////////////////////////////////////////


module tree_multiplier_csa_sequential ( a, b, result, clk, rst );
  input [31:0] a;
  input [31:0] b;
  output [63:0] result;
  input clk, rst;
  wire   slow_clk, \counter[1] , N3, n3, n4, n5, n7, n8, n9, n10, n11, n12,
  ...
  DFFASX1 \counter_reg[0]  ( .D(\counter[1] ), .CLK(clk), .SETB(n22), .Q(n7)
         );
  DFFARX1 \counter_reg[1]  ( .D(N3), .CLK(clk), .RSTB(n22), .Q(\counter[1] ), 
        .QN(n3) );
  DFFARX1 slow_clk_reg ( .D(n5), .CLK(clk), .RSTB(n22), .Q(slow_clk), .QN(n4)
         );
  ...
  NBUFFX2 U7 ( .INP(n8), .Z(n12) );
  NBUFFX2 U8 ( .INP(n8), .Z(n13) );
  NBUFFX2 U9 ( .INP(n8), .Z(n14) );
  NBUFFX2 U10 ( .INP(n9), .Z(n15) );
  NBUFFX2 U11 ( .INP(n9), .Z(n16) );
  NBUFFX2 U12 ( .INP(n9), .Z(n17) );
  NBUFFX2 U13 ( .INP(n10), .Z(n18) );
  NBUFFX2 U14 ( .INP(n10), .Z(n19) );
  NBUFFX2 U15 ( .INP(n10), .Z(n20) );
  NBUFFX2 U16 ( .INP(n11), .Z(n21) );
  NBUFFX2 U17 ( .INP(n11), .Z(n22) );
  NBUFFX2 U18 ( .INP(n38), .Z(n8) );
  NBUFFX2 U19 ( .INP(n38), .Z(n9) );
  NBUFFX2 U20 ( .INP(n38), .Z(n10) );
  NBUFFX2 U21 ( .INP(n38), .Z(n11) );
  NBUFFX2 U22 ( .INP(n23), .Z(n27) );
  NBUFFX2 U23 ( .INP(n23), .Z(n28) );
  NBUFFX2 U24 ( .INP(n23), .Z(n29) );
  NBUFFX2 U25 ( .INP(n24), .Z(n30) );
  NBUFFX2 U26 ( .INP(n24), .Z(n31) );
  NBUFFX2 U27 ( .INP(n24), .Z(n32) );
  NBUFFX2 U28 ( .INP(n25), .Z(n33) );
  NBUFFX2 U29 ( .INP(n25), .Z(n34) );
  NBUFFX2 U30 ( .INP(n25), .Z(n35) );
  NBUFFX2 U31 ( .INP(n26), .Z(n36) );
  NBUFFX2 U32 ( .INP(n26), .Z(n37) );
  AND2X1 U33 ( .IN1(n7), .IN2(n3), .Q(N3) );
  INVX0 U34 ( .INP(rst), .ZN(n38) );
  NBUFFX2 U35 ( .INP(slow_clk), .Z(n23) );
  NBUFFX2 U36 ( .INP(slow_clk), .Z(n24) );
  NBUFFX2 U37 ( .INP(slow_clk), .Z(n25) );
  NBUFFX2 U38 ( .INP(slow_clk), .Z(n26) );
endmodule

...
module samul_v1_sequential ( a, b, result, clk, rst );
  input [31:0] a;
  input [31:0] b;
  output [63:0] result;
  input clk, rst;
  ...
  NBUFFX2 U17 ( .INP(n11), .Z(n21) );
  NBUFFX2 U18 ( .INP(n11), .Z(n22) );
  NBUFFX2 U19 ( .INP(n38), .Z(n8) );
  NBUFFX2 U20 ( .INP(n38), .Z(n9) );
  NBUFFX2 U21 ( .INP(n38), .Z(n10) );
  NBUFFX2 U22 ( .INP(n38), .Z(n11) );
  NBUFFX2 U23 ( .INP(n23), .Z(n27) );
  NBUFFX2 U24 ( .INP(n23), .Z(n28) );
  NBUFFX2 U25 ( .INP(n23), .Z(n29) );
  NBUFFX2 U26 ( .INP(n24), .Z(n30) );
  NBUFFX2 U27 ( .INP(n24), .Z(n31) );
  NBUFFX2 U28 ( .INP(n24), .Z(n32) );
  NBUFFX2 U29 ( .INP(n25), .Z(n33) );
  NBUFFX2 U30 ( .INP(n25), .Z(n34) );
  NBUFFX2 U31 ( .INP(n25), .Z(n35) );
  NBUFFX2 U32 ( .INP(n26), .Z(n36) );
  NBUFFX2 U33 ( .INP(n26), .Z(n37) );

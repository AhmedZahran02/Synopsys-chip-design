...
module csa_64 ( a, b, cin, sum, cout );
  ...
  csa_32 u1 ( .a(a[31:0]), .b(b[31:0]), .cin(cin), .sum(sum[31:0]), .cout(
        cs_signal) );
  csa_32 u2 ( .a(a[63:32]), .b(b[63:32]), .cin(1'b0), .sum(s1), .cout(c1) );
  csa_32 u3 ( .a(a[63:32]), .b(b[63:32]), .cin(1'b1), .sum(s2), .cout(c2) );
